<%@ Page Title="" Language="C#" MasterPageFile="~/CoS/CoSMaster.Master" AutoEventWireup="true" CodeBehind="Dashboard_ClosedCases_Details.aspx.cs" Inherits="CMS_Sampada.CoS.Dashboard_ClosedCases_Details" %>
                        ...
                        <div class="col-lg-offset-12 col-md-offset-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="table-responsive listtabl">
                                <asp:GridView ID="grdCaseList" CssClass="table table-bordered table-condensed table-striped table-hover"
                                    ...
                                    AutoGenerateColumns="False" Visible="true" Width="100%" EmptyDataText="No Closed cases" HeaderStyle-Font-Bold="false">
