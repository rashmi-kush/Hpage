<%@ Page Title="" Language="C#" MasterPageFile="~/CoS/CoSMaster.Master" AutoEventWireup="true" CodeBehind="Hearing_Notice.aspx.cs" Inherits="CMS_Sampada.CoS.Hearing_Notice" ValidateRequest="false" %>
                                                                ...
                                                                <asp:Panel ID="pnlNotice" runat="server" Visible="false">
                                                                    <div class="row">
                                                                        ...
                                                                        <asp:Label ID="lblCaseNo" runat="server"></asp:Label>
                                                                            ...
                                                                            <br />
                                                                            <br />
                                                                            <b class="stamp">स्थान- न्यायालय कलेक्टर ऑफ स्टाम्प एवं जिला पंजीयक कार्यालय
