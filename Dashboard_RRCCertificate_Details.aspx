<%@ Page Title="" Language="C#" MasterPageFile="~/CoS/CoSMaster.Master" AutoEventWireup="true" CodeBehind="Dashboard_RRCCertificate_Details.aspx.cs" Inherits="CMS_Sampada.CoS.Dashboard_RRCCertificate_Details" %>
                        ...
                        <div class="card-body">
                            ...
                            <div class="col-lg-offset-12 col-md-offset-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="table-responsive listtabl">
                                    ...
                                    AutoGenerateColumns="False" Visible="true" Width="100%" EmptyDataText="No RRC Certificate">
