<%@ Page Title="" Language="C#" MasterPageFile="~/CoS/CoSMaster.Master" AutoEventWireup="true" CodeBehind="COS_Generate_FinalOrderList.aspx.cs" Inherits="CMS_Sampada.CoS.COS_Generate_FinalOrderList" %>
                        ...
                        <div class="col-lg-offset-12 col-md-offset-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="table-responsive listtabl">
                                <asp:GridView ID="grdCaseList" CssClass="table table-bordered table-condensed table-striped table-hover"
                                    DataKeyNames="APP_ID,APPLICATION_NUMBER,CASE_NUMBER,FINAL_ORDER_DATE,TOTAL_DEFICIT_AMOUNT,TOTAL_PENALTY_AMOUNT,FINAL_PAYABLE_AMOUNT,PAYMENT_MODE,
                                    PAID_AMOUNT,Difference_Amount,PAYMENT_STATUS,PAYMENT_DATE,Apeal_Status"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="TOTAL DEFICIT AMOUNT" HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Top">
                                            <HeaderStyle CssClass="centered-header" />
                                            <ItemTemplate>
                                                <div style="text-align: center">
                                                    <asp:Label ID="lblTOTAL_DEFICIT_AMOUNT" runat="server" Text='<%# Eval("TOTAL_DEFICIT_AMOUNT") %>'></asp:Label>
                                                </div>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="TOTAL PENALTY AMOUNT" HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Top">
                                            <HeaderStyle CssClass="centered-header" />
                                            <ItemTemplate>
                                                <div style="text-align: center">
                                                    <asp:Label ID="lblTOTAL_PENALTY_AMOUNT" runat="server" Text='<%# Eval("TOTAL_PENALTY_AMOUNT") %>'></asp:Label>
                                                </div>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="PAYMENT MODE" HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Top">
                                            <HeaderStyle CssClass="centered-header" />
                                            <ItemTemplate>
                                                <div style="text-align: center">
                                        ...
                                        <asp:TemplateField HeaderText="PAID AMOUNT" HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Top">
                                            <HeaderStyle CssClass="centered-header" />
                                            <ItemTemplate>
                                                <div style="text-align: center">
                                        ...
                                        <asp:TemplateField HeaderText="Difference Amount" HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Top">
                                            <HeaderStyle CssClass="centered-header" />
                                            <ItemTemplate>
                                                <div style="text-align: center">
                                                    <asp:Label ID="lblDifference_Amount" runat="server" Text='<%# Eval("Difference_Amount") %>'></asp:Label>
                                                </div>
                                            </ItemTemplate>
                                        </asp:TemplateField>
