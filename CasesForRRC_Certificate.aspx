<%@ Page Title="" Language="C#" MasterPageFile="~/CoS/CoSMaster.Master" AutoEventWireup="true" CodeBehind="CasesForRRC_Certificate.aspx.cs" Inherits="CMS_Sampada.CoS.CasesForRRC_Certificate" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    ...
                    <h5>Cases Pending For RRC Certificate</h5>
                </div>
                        ...
                        <div class="card-header p-2 pt-1 d-flex align-items-center">
                            <div class="col-sm-6 p-0">
                                <ul class="nav nav-pills">
                                    <li class="nav-item "><a class="nav-link active" href="CasesForRRC_Certificate">Pending RRC Certificate</a></li>
                                    <li class="nav-item"><a class="nav-link " href="Done_RRC_Certificate_Cases">Done RRC Certificate</a></li>
                            ...
                            <div class="col-lg-offset-12 col-md-offset-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="table-responsive listtabl">
                                    <asp:GridView ID="grdCaseList" CssClass="table table-bordered table-condensed table-striped table-hover"
                                        ...
                                        AutoGenerateColumns="False" Visible="true" Width="100%" EmptyDataText="No RRC cases" OnRowDataBound="Grd_RRC_Certi_Proced_RowDataBound" OnRowEditing="Grd_RRC_Certi_Proced_RowEditing">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderStyle-Font-Bold="false" HeaderText="Final Order Date">
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderStyle-Font-Bold="false" HeaderText=" COS Action">
                                                <ItemStyle Width="4%" HorizontalAlign="Right" />
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lnkSelect" runat="server" CommandArgument='<%#Eval("App_ID") %>' CommandName="SelectApplication" OnClientClick="return checkDisabled(this);" OnClick="lnkSelect_Click" CssClass="btn btn-secondary ">Select</asp:LinkButton>
    ...
    <script type="text/javascript">
        ...
        function checkDisabled(link) {
            ...
            console.log('Link classes:', link.classList);
            if (link.classList.contains('aspNetDisabled')) {
                swal.fire('warning!', 'RRC Certificate can only be created on or after the 29th day following the final order date.', 'warning');
