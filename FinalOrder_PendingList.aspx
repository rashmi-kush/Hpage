<%@ Page Title="" Language="C#" MasterPageFile="~/CoS/CoSMaster.Master" AutoEventWireup="true" CodeBehind="FinalOrder_PendingList.aspx.cs" Inherits="CMS_Sampada.CoS.FinalOrder_PendingList" %>
                        ...
                        <div class="card-header p-2 pt-1 d-flex align-items-center">
                            <div class="col-sm-6 p-0">
                                <ul class="nav nav-pills">
                                    ...
                                    <li class="nav-item"><a class="nav-link active" href="FinalOrder_PendingList">Pending Final Order</a></li>
                                   <li class="nav-item"><a class="nav-link" href="COS_FinalOrder_List">Save For Later Final Order</a></li>
                        ...
                        <div class="card-body">
                            ...
                            <div class="col-lg-offset-12 col-md-offset-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="table-responsive listtabl">
                                    ...
                                    DataKeyNames="app_id,Proposal_No,Registered_CaseNO,Hearing_Date,Case_Status,party_id,NOTICE_PROCEEDING,NOTICE_DOCSPATH,Notice_ID,hearing_id,hearingdate,status_id"
