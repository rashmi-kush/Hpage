<%@ Page Title="" Language="C#" MasterPageFile="~/CoS/CoSMaster.Master" AutoEventWireup="true" CodeBehind="EarlyHearingListCases.aspx.cs" Inherits="CMS_Sampada.CoS.EarlyHearingListCases" %>
        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    ...
                    <h5>Early Hearing / Party Reply</h5>
                </div>
                <%-- <div class="col-sm-6">
                        ...
                        <div class="card-body">
                            ...
                            <div class="col-lg-offset-12 col-md-offset-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="table-responsive listtabl">
                                    ...
                                    AutoGenerateColumns="False" Visible="true" Width="100%" EmptyDataText="No Early Hearing">
